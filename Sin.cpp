...
#include <numbers> // For std::numbers::pi in C++20 and later

int main() {
    // Calculate sine of an angle in radians
    double angle_radians = std::numbers::pi / 2.0; // 90 degrees in radians
    double sine_value_radians = std::sin(angle_radians);
    std::cout << "Sine of " << angle_radians << " radians: " << sine_value_radians << std::endl;

    // Calculate sine of an angle in degrees (requires conversion)
